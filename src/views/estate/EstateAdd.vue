	...
	<b-overlay class="h-100" :show="isLoading" rounded="sm">
		<div class="container mt-4 mb-5 d-flex flex-column gap-4">
			...
			<div class="section-card">
				<h5 class="section-title"><i class="fa-solid fa-circle-info"></i>기본 정보</h5>
				<b-form>
			...
			<div class="section-card">
				<h5 class="section-title"><i class="fa-solid fa-handshake"></i>거래 정보</h5>
				<b-form>
					<b-form-row class="mb-3">
						<div class="w-100">
							<label> 보증금 / 월세 </label>
			...
			<div class="section-card">
				<h5 class="section-title"><i class="fa-solid fa-list-check"></i>기타 정보</h5>
				<b-form>
					<b-form-row>
						<div class="w-100">
							<label> 엘리베이터 </label>
